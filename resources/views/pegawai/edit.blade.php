        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form-save">
                            <input type="hidden" value="{{ $pegawai->id }}" id="id_pegawai" name="id_pegawai">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan"
                                    value="{{ $pegawai->nama_karyawan }}" />
                            </div>
                            <div class="form-group">
                                <label for="tempat_lahir">Tempat Lahir</label>
                                <textarea class="form-control" id="tempat_lahir" name="tempat_lahir">{{ $pegawai->tempat_lahir }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group date tgl_lahir" id="tgl_lahir" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#tgl_lahir"
                                        value="{{ $pegawai->tgl_lahir ? \Carbon\Carbon::parse($pegawai->tgl_lahir)->format('Y-m-d') : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="agama" id="agama" class="form-control select2bs4">
                                    ...
                                    <option value="hindhu" {{ $pegawai->agama == 'hindhu' ? 'selected' : '' }}>Hindhu
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_nikah" id="status_nikah" class="form-control select2bs4">
                                    ...
                                    <option value="belum kawin"
                                        {{ $pegawai->status_nikah == 'belum kawin' ? 'selected' : '' }}>
                                        Belum Kawin</option>
                                    <option value="kawin" {{ $pegawai->status_nikah == 'kawin' ? 'selected' : '' }}>Kawin
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="pendidikan" id="pendidikan" class="form-control select2bs4">
                                    ...
                                    <option value="SMA/SMK/Sederajat"
                                        {{ $pegawai->pendidikan == 'SMA/SMK/Sederajat' ? 'selected' : '' }}>
                                        SMA/SMK/Sederajat
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tgl_diangkat" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input"
                                        ...
                                        value="{{ $pegawai->tgl_diangkat ? \Carbon\Carbon::parse($pegawai->tgl_diangkat)->format('Y-m-d') : '' }}">
        ...
        $(document).ready(function() {
            ...
            $('#form-save').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    setLoadingState();
                    const url = "{{ url('/api/pegawai') }}" + "/" + $('#id_pegawai').val();;
                    fetch(url, {
                            method: 'PUT',
                            headers: {
